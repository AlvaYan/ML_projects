...
class GraphNodeFeature(nn.Module):
    ...
    def __init__(
        ...
        self.atom_encoder = nn.Linear(in_features=2,out_features=hidden_dim)#modification
    ...
    def forward(self, batched_data):
        ...
        node_feature = self.atom_encoder(x.half())#modification
